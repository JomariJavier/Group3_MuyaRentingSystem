...
Partial Class AdminForm6
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(AdminForm6))
        ...
        TableLayoutPanel2.RowStyles.Add(New RowStyle(SizeType.Percent, 10F))
        TableLayoutPanel2.RowStyles.Add(New RowStyle(SizeType.Percent, 10F))
        TableLayoutPanel2.Size = New Size(1284, 685)
        ...
        Label3.Location = New Point(543, 16)
        Label3.Name = "Label3"
        Label3.Size = New Size(195, 37)
        Label3.TabIndex = 1
        Label3.Text = "FULL ADDRESS"
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(1010, 16)
        Label7.Name = "Label7"
        ...
        Label2.Location = New Point(135, 16)
        Label2.Name = "Label2"
        ...
        Button1.Location = New Point(1079, 107)
